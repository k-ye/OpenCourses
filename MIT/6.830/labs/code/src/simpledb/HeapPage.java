...
/**
 * HeapPage stores pages of a HeapFile and implements the Page interface that
...
public class HeapPage implements Page {
     ...
     * The number of 8-bit header words (bytes) is equal to:
     * <p>
    ...
    private int getHeaderSize() {
        int headerSize = ((getNumTuples() + 7) / 8);
        return headerSize;
    }
    ...
    public Iterator<Tuple> iterator() {
        class HpIterator implements Iterator<Tuple> {
            ...
            private void fixCur() {
                while (cur < numSlots && !getSlot(cur)) {
                    ++cur;
                }
            }
            ...
            public Tuple next() throws NoSuchElementException {
                if (!hasNext()) {
                    throw new NoSuchElementException("End of HeapPage");
                }
