...
//       ambiguities** ATC April 26, 2008 **Added GBN descriptions May 1, 2009
//       ** Clarified that srt_server_recv blocks until all the requested data
//       is ready ** ATC
//
...
// the connection to LISTENING. It then starts a timer to ``busy wait'' until
// the TCB's state changes to CONNECTED (seghandler does this when a SYN is
...
// of bytes (i.e., length) are at the server before returning data to the
// application
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
