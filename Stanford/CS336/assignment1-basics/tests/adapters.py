...
from cs336_basics.bpe import Tokenizer, train_bpe_tokenizer
...
def run_swiglu(
    ...
    sw = SwiGLU(d_model, d_ff, w1_weight.device, w1_weight.dtype)
    sw.load_state_dict(
        {
            "w1.weight": w1_weight,
            "w2.weight": w2_weight,
...
def run_transformer_block(
    ...
    return tb.forward(in_features, token_positions)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    do_gradient_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return calc_lr_cosine_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
