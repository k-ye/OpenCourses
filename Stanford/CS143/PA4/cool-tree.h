...
public:
   ...
   virtual Attribute get_attr(Symbol s) const = 0;
   virtual Method get_method(Symbol s) const = 0;
...
public:
   ...
   virtual void analyze() = 0;
   virtual Feature_Kind kind() const = 0;
   virtual Symbol get_name() const = 0;
...
public:
   ...
   virtual Attribute get_attr(Symbol s) const;
   virtual Method get_method(Symbol s) const;
...
public:
   ...
   Feature_Kind kind() const { return Feature_Kind::METH_; }
   virtual Symbol get_name() const { return name; }
   virtual Formals get_formals() const { return formals; }
   virtual Symbol get_return_type() const { return return_type; }
...
public:
   ...
   Feature_Kind kind() const { return Feature_Kind::ATTR_; }
   virtual Symbol get_name() const { return name; }
...
public:
   ...
   virtual Symbol get_name() const { return name; }
   virtual Symbol get_type_decl() const { return type_decl; } 
   virtual Symbol get_expr_type() { return expr->get_type(); }
   virtual void analyze();
