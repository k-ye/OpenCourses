# @pre Should create subfiles of "task4/" before using
# read args
...
w.gen <- function()
{
  return(read.table('weights.txt')[[1]])
}
...
save(result, file=sprintf("task4/task4_id%d_mu%.1f_std%.1f.rda", job.id, mu, std))
